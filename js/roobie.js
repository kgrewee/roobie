    ...
    if (event.matches) {
        ...
        for (i = 0; i < menus.length; i++) {
            ...
            if (!$(menus[i]).find(".rsp-cnt").hasClass("rsp-cnt")) {
                menus[i].innerHTML = '<div class="drp"> <button class="drp-btn flx-row aln-center bdr-none"> <img width="25" height="25" src="icons/fontawesome-menu-black.svg"> </button> <div class = "drp-cnt pad br rsp-cnt">' + items + '</div> </div>';
            }
        }
    }
}
